...
public class ConfigScreen extends Screen {
    ...
    private net.minecraft.client.input.KeyInput pendingZoomKeyInput = null;
    ...
    protected void init() {
        ...
        this.addDrawableChild(ButtonWidget.builder(
                ...
                button -> {
                    ...
                    pendingZoomKeyInput = new net.minecraft.client.input.KeyInput(GLFW.GLFW_KEY_C, 0, 0);
                    this.clearChildren();
                    this.init();
                }
        ...
        this.addDrawableChild(ButtonWidget.builder(
                ...
                button -> {
                    ...
                    if (pendingZoomKeyActive) {
                        if (pendingZoomKeyEscape) {
                            JiZoomCinematic.ZOOM_KEY.setBoundKey(InputUtil.UNKNOWN_KEY);
                        } else {
                            JiZoomCinematic.ZOOM_KEY.setBoundKey(InputUtil.fromKeyCode(pendingZoomKeyInput));
                        }
    ...
    private Text getZoomKeyText() {
        if (pendingZoomKeyActive) {
            if (pendingZoomKeyEscape) return Text.translatable("config.ji_zoom_cinematic.zoom_key").append(Text.literal(": \u00A7eNONE"));
            return Text.translatable("config.ji_zoom_cinematic.zoom_key").append(Text.literal(": \u00A7e" + InputUtil.fromKeyCode(pendingZoomKeyInput).getLocalizedText().getString().toUpperCase()));
        }
